        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            <input type="text" class="form-control w-50 mx-auto" placeholder="Product ID"
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control w-50 mx-auto" placeholder="Product Quantity"
                                v-model="payload.quantity" />
                        </div>
                        <div class="mb-3">
                            <input type="text" class="form-control w-50 mx-auto" placeholder="Product Amount"
                                v-model="payload.cost" />
                        </div>
                        <div class="mb-3">
                            <input type="text" class="form-control w-50 mx-auto" placeholder="Product Category"
                                v-model="payload.category" />
                        </div>
                        <div class="mb-3">
                            <input type="text" class="form-control w-50 mx-auto" placeholder="Product URL"
                                v-model="payload.prodURL" />
                        </div>
                        <div class="mb-3">
                            <input type="text" class="form-control w-50 mx-auto" placeholder="Product Desc"
